...
namespace TK.CustomMap.Api.GoogleAPI
{
    ...
    public sealed class GmsPlace
    {
        ...
        const string UrlPredictions = "place/nearbysearch/json?location=17.4474,78.3762&radius=1000&type=school";
        ...
        public async Task<GmsPlaceResult> GetNearByPredictions(string searchText)
        {
        ...
        {
            return string.Format("{0}&keyword={1}&key={2}", UrlPredictions, searchText, _apiKey);
        }
        /// <summary>
