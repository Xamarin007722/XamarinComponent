...
namespace XamarinComponent.Views
{
    public class Loading : ContentPage
    {
        ...
        public static readonly BindableProperty ShadeBackgroundProperty = BindableProperty.Create("ShadeBackground", typeof(bool), typeof(Loading), false);
        public static readonly BindableProperty LoadingMessageProperty = BindableProperty.Create("LoadingMessage", typeof(string), typeof(Loading), "Loading...");
        public static readonly BindableProperty WaitingOrientationProperty = BindableProperty.Create("WaitingOrientation", typeof(StackOrientation), typeof(Loading), StackOrientation.Vertical);
